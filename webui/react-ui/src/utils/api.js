...
export const agentApi = {
  ...
  getAgentConfig: async (name) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.agentConfig(name)),
      {
        headers: API_CONFIG.headers,
      }
    );
  ...
  getAgentConfigMetadata: async () => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.agentConfigMetadata),
      {
        headers: API_CONFIG.headers,
      }
    );
  ...
  deleteAgent: async (name) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.deleteAgent(name)),
      {
        method: "DELETE",
        headers: API_CONFIG.headers,
      }
  ...
  pauseAgent: async (name) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.pauseAgent(name)),
      {
        method: "PUT",
        headers: API_CONFIG.headers,
        body: JSON.stringify({}),
  ...
  startAgent: async (name) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.startAgent(name)),
      {
        method: "PUT",
        headers: API_CONFIG.headers,
        body: JSON.stringify({}),
  ...
  exportAgentConfig: async (name) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.exportAgent(name)),
      {
        headers: API_CONFIG.headers,
      }
    );
  ...
  generateGroupProfiles: async (data) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.generateGroupProfiles),
      {
        method: "POST",
        headers: API_CONFIG.headers,
...
export const chatApi = {
  ...
  getChatHistory: async (id) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.chatHistory(id)),
      {
        headers: API_CONFIG.headers,
      }
    );
...
export const actionApi = {
  ...
  executeAction: async (name, actionData) => {
    const response = await fetch(
      buildUrl(API_CONFIG.endpoints.executeAction(name)),
      {
        method: "POST",
        headers: API_CONFIG.headers,
